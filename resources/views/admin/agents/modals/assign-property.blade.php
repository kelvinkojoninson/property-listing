        ...
        <div class="modal-content">
                ...
                <form id="assign-property-form" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <select name="agent" id="agents-dropdown" class="form-control" required>
            ...
            <div class="row mt-2">
                <div class="col">
                    ...
                    <select name="property" id="property-dropdown" class="form-control" required>
...
<script>
    ...
    $(assignPropertyForm).submit(function(e) {
        ...
        Swal.fire({
            title: 'Are you sure you want to assign property to this realtor?',
            icon: 'warning',
            ...
            if (result.value) {
                ...
                fetch(`${APP_URL}/api/agents/assign_property`, {
                    method: "POST",
                    body: formdata,
                }).then(function(res) {
                    return res.json()
