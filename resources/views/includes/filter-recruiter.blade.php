@section('filter-recruiter')
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader"
        style="background-color: #663259; background-position: right bottom; background-size: auto 100%; background-repeat: no-repeat; background-image: url({{ asset('assets/media/svg/patterns/taieri.svg') }})">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            <!--begin::Info-->
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Page Title-->
                <h5 class="text-white font-weight-bold mt-2 mb-2 mr-5">@yield('page-name')</h5>
                <!--end::Page Title-->
                <!--begin::Actions-->
                <div class="subheader-separator subheader-separator-ver mt-2 mb-2 mr-4 bg-gray-200"></div>
                <div class="bg-white rounded p-1 d-flex flex-grow-1 flex-sm-grow-0">
                    <!--begin::Form-->
                    <form class="form d-flex align-items-md-center flex-sm-row flex-column flex-grow-1 flex-sm-grow-0">
                        ...
                        <div class="d-flex align-items-center py-3 py-sm-0 px-sm-3">
                            ...
                            <input type="text" id="search-name" value="{{ request()->companyID === 'all' ? '' : request()->companyID}}" class="form-control border-0 font-weight-bold pl-2"
                                placeholder="Recruiter Name" />
                        </div>
                        <!--end::Input-->
                        <!--begin::Input-->
                        <span class="bullet bullet-ver h-25px d-none d-sm-flex mr-2"></span>
                        <div class="d-flex align-items-center py-3 py-sm-0 px-sm-6">
                            <span class="svg-icon svg-icon-lg">
                            ...
                            <select id="search-industry" style="width:100%" class="form-control form-control-lg form-control-solid select2"
                                required>
                                <option value="">Select Industry</option>
                                @foreach ($industries as $industry)
                                    <option value="{{ $industry->transid }}" @if (request()->industryID == $industry->transid) selected @endif>
                        ...
                        <!--end::Input-->
                        <button type="button" id="filter-recruiter-button"
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown dropdown-inline" data-toggle="tooltip" data-placement="left">
                    <a href="{{ config('app.url') }}/register-recruiter" target="_blank"
                        class="btn btn-sm btn-light btn-icon" aria-haspopup="true" aria-expanded="false">
