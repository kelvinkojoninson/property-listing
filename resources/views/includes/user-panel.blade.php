    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
            <div class="symbol symbol-100 mr-5">
                <div class="symbol-label" style="background-image:url('{{ empty(Auth::user()->picture) ? asset('assets/media/users/default.jpg') : Auth::user()->picture }}')"></div>
                <i class="symbol-badge bg-success"></i>
            </div>
            <div class="d-flex flex-column">
                <a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">{{ Auth::user()->fname.' '.  Auth::user()->lname }}</a>
                <div class="text-muted mt-1">{{ Auth::user()->role == 'agent' ? 'Realtor' : ucfirst(Auth::user()->role) }}</div>
                <div class="navi mt-2">
                    ...
                    <form method="POST" action="{{ route('logout') }}" id="logout-form">
                        @csrf
                        <a style="cursor:pointer" onclick="event.preventDefault(); document.forms['logout-form'].submit()" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Sign Out</a>
                    </form>
                </div>
            </div>
        </div>
