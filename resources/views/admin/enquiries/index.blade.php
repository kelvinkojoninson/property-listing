...
@section('page-content')
                    ...
                    <ul class="nav nav-tabs nav-tabs-space-lg nav-tabs-line nav-tabs-bold nav-tabs-line-3x" role="tablist">
                        <li class="nav-item mr-3">
                            <a class="nav-link active" data-toggle="tab" href="#kt_apps_projects_view_tab_2">
                                ...
                                <span class="nav-text font-weight-bold">Enquiries</span>
                            </a>
                        </li>
                        <li class="nav-item mr-3">
                ...
                <div class="tab-content pt-5">
                    ...
                    <div class="tab-pane active" id="kt_apps_projects_view_tab_2" role="tabpanel">
                        <div class="row mt-2 p-3">
                            ...
                            <div class="col">
                                <button class="btn btn-light-primary font-weight-bold" id="filter-enquiry"
                                    style="margin-top:26px"><i class="fa fa-filter"></i> FILTER</button>
                            </div>
                        </div>
                        <div class="table-responsive">
                            <table class="table table-vertical-center dataTable js-exportable" id="enquiry-table">
                                <thead>
                                    <tr class="text-left">
                                        <th style="width: 5px">No.</th>
                                        <th class="pr-0">Enquirier</th>
                                        <th class="pr-0">Property</th>
                                        <th class="pr-0">Phone</th>
                                        <th class="pr-0">Email</th>
                                        <th class="pr-0">Message</th>
                    ...
                    <div class="tab-pane" id="kt_apps_projects_view_tab_3" role="tabpanel">
                        <div class="row mt-2 p-3">
                           <div class="col">
                            ...
                            <div class="col">
                                <button class="btn btn-light-primary font-weight-bold" id="trash-filter-enquiry"
                                    style="margin-top:26px"><i class="fa fa-filter"></i> FILTER</button>
                            </div>
                        </div>
                        <div class="table-responsive">
    ...
    <script>
        ...
        var enquiryTable = $('#enquiry-table').DataTable({
            dom: "Bfrtip",
            ajax: {
                url: `${APP_URL}/api/enquiries/${upcomingDateFrom}/${upcomingDateTo}`,
                type: "GET"
        ...
        // FILTER 
        $('#filter-enquiry').click(function() {
            var upcomingDateFrom = document.getElementById('start-date').value;
            var upcomingDateTo = document.getElementById('end-date').value;

            invitationsTable.ajax.url(
                    `${APP_URL}/api/enquiries/${upcomingDateFrom}/${upcomingDateTo}`
                )
                .load();
        })
        ...
        var trashTable = $('#trash-table').DataTable({
            dom: "Bfrtip",
            ajax: {
                url: `${APP_URL}/api/enquiries/trash/${upcomingDateFrom}/${upcomingDateTo}`,
                type: "GET"
        ...
        // FILTER 
        $('#trash-filter-enquiry').click(function() {
            var upcomingDateFrom = document.getElementById('trash-start-date').value;
            var upcomingDateTo = document.getElementById('trash-end-date').value;

            trashTable.ajax.url(
                    `$${APP_URL}/api/enquiries/trash/${upcomingDateFrom}/${upcomingDateTo}`
                )
                .load();
        })

        $("#enquiry-table").on("click", ".delete-btn", function() {
            var data = enquiryTable.row($(this).parents("tr")).data();
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    fetch(`${APP_URL}/api/enquiries/delete`, {
                        method: "POST",
                        body: formdata,
                    }).then(function(res) {
                        return res.json()
                        ...
                        enquiryTable.ajax.reload(false, null);
        ...
        $("#trash-table").on("click", ".restore-btn", function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    fetch(`${APP_URL}/api/enquiries/restore`, {
                        method: "POST",
                        body: formdata,
                    }).then(function(res) {
                        return res.json()
                        ...
                        Swal.fire({
                            text: "Enquiries restored successfully",
                            icon: "success"
                        });
                        trashTable.ajax.reload(false, null);
                        enquiryTable.ajax.reload(false, null);
        ...
        $("#enquiry-table").on("click", ".update-btn", function() {
            let data = enquiryTable.row($(this).parents('tr')).data();

            $("#update-modal").modal("show");
            // $("#update-transid").val(data.transid);
            // $("#update-owner-name").val(data.ownerName);
