...
<script src="{{ asset('assets/plugins/custom/leaflet/leaflet.bundle.js?v=7.2.8')}}"></script>
<script src="{{ asset('assets/js/pages/crud/file-upload/image-input.js?v=7.2.8')}}"></script>
